...
各コンセプトには以下を含めてください：
1. **キャラクター・モチーフ**: 非常に詳細に描写すること。色、形、特徴、雰囲気、日本文化的要素を具体的に記述。例：「赤い提灯の形をした可愛らしいお化け、大きな黒い目と小さな口、ほんのり光る黄色の明かりが内側から漏れている、周りには薄紫色の霧が漂う」
2. **フレーズ**: 必ず『ひらがな』を主体とすること（カタカナは最小限）。短く覚えやすいキャッチコピー。
3. **フォントスタイル**: 'pop', 'horror', 'retro', 'modern' のいずれか1つ

重要：characterフィールドは、AI画像生成に使用されるため、視覚的な詳細（色、形、質感、雰囲気、背景色）を豊富に含めること。`;
